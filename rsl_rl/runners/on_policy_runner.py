...
import rsl_rl
from rsl_rl.algorithms import PPO, PPO_LCP, Distillation
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        self.alg: PPO | PPO_LCP | Distillation = alg_class(policy, device=self.device, **self.alg_cfg, multi_gpu_cfg=self.multi_gpu_cfg)
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        self.writer.add_histogram("Policy/param1", distribution_params[..., 0], locs["it"])
        self.writer.add_histogram("Policy/param2", distribution_params[..., 1], locs["it"])
